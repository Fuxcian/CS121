...
public class BinarySearchTester {
    public static void main(String[] args) {
        ...
        for (int num : list) //changes to list instead of array
            System.out.print(num + " ");
        System.out.println();

        // sort array
        ArrayList<Integer> sortedList = selectionSort(list); //sorted list instead of array
    ...
    public static ArrayList<Integer> selectionSort(ArrayList<Integer> unsortedList) {
        ...
        for (int i = 0; i < sortedList.size()-1; i++) {
            ...
            // ArrayList.set() returns the old variable that the method replaces. (Note from group member)
